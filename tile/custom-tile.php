...
class Disciple_Tools_Tasks_Tile
{
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = '' ) {
        if ( $post_type === 'contacts' || $post_type === 'tasks' ){
            $tiles['disciple_tools_tasks'] = [ 'label' => __( 'Tasks', 'disciple-tools-tasks' ) ];
            $tiles['a_beautiful_tile'] = [ 'label' => __( 'A Beautiful Tile', 'disciple-tools-tasks' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_custom_fields( array $fields, string $post_type = '' ) {
        ...
        if ( $post_type === 'contacts' || $post_type === 'tasks' ){
             ...
             */
            $fields['disciple_tools_tasks_text'] = [
                'name'        => __( 'Text', 'disciple-tools-tasks' ),
                'description' => _x( 'Text', 'Optional Documentation', 'disciple-tools-tasks' ),
                'type'        => 'text',
                'default'     => '',
                'tile' => 'disciple_tools_tasks',
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ];
            /**
             * This is an example of a multiselect field
             */
            $fields['disciple_tools_tasks_multiselect'] = [
                'name' => __( 'Multiselect', 'disciple-tools-tasks' ),
                'default' => [
                    'one' => [ 'label' => __( 'One', 'disciple-tools-tasks' ) ],
                    'two' => [ 'label' => __( 'Two', 'disciple-tools-tasks' ) ],
                    'three' => [ 'label' => __( 'Three', 'disciple-tools-tasks' ) ],
                    'four' => [ 'label' => __( 'Four', 'disciple-tools-tasks' ) ],
                ],
                'tile' => 'disciple_tools_tasks',
                'type' => 'multi_select',
                'hidden' => false,
             ...
             */
            $fields['disciple_tools_tasks_keyselect'] = [
                'name' => 'Key Select',
                'type' => 'key_select',
                'tile' => 'disciple_tools_tasks',
                'default' => [
                    'first'   => [
                        'label' => _x( 'First', 'Key Select Label', 'disciple-tools-tasks' ),
                        'description' => _x( 'First Key Description', 'Training Status field description', 'disciple-tools-tasks' ),
                        'color' => '#ff9800'
                    ],
                    'second'   => [
                        'label' => _x( 'Second', 'Key Select Label', 'disciple-tools-tasks' ),
                        'description' => _x( 'Second Key Description', 'Training Status field description', 'disciple-tools-tasks' ),
                        'color' => '#4CAF50'
                    ],
                    'third'   => [
                        'label' => _x( 'Third', 'Key Select Label', 'disciple-tools-tasks' ),
                        'description' => _x( 'Third Key Description', 'Training Status field description', 'disciple-tools-tasks' ),
                        'color' => '#366184'
                    ],
                ],
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ...
            //test fields
            $fields['number_test'] = [
                'name'        => __( 'Number field', 'disciple-tools-tasks' ),
                'type'        => 'number',
                'default'     => 0,
            ...
            $fields['number_test_private'] = [
                'name'        => __( 'Number field private', 'disciple-tools-tasks' ),
                'type'        => 'number',
                'default'     => 0,
                'tile'        => 'a_beautiful_tile',
                'private'     => true,
            ...
            $fields['contact_communication_channel_test'] = [
                'name'        => __( 'Communication Channel', 'disciple-tools-tasks' ),
            ...
            $fields['user_select_test'] = [
                'name'        => __( 'User Select', 'disciple-tools-tasks' ),
                'type'        => 'user_select',
                'tile'        => 'a_beautiful_tile'
            ];
            $fields['array_test'] = [
                'name'        => __( 'Array', 'disciple-tools-tasks' ),
                'type'        => 'array',
                'tile'        => 'a_beautiful_tile'
            ];
            ...
            $fields['date_test'] = [
                'name'        => __( ' Date Field', 'disciple-tools-tasks' ),
                'description' => '',
                'type'        => 'date',
                'default'     => '',
                'tile' => 'a_beautiful_tile'
            ...
            $fields['boolean_test'] = [
                'name'        => __( 'Boolean', 'disciple-tools-tasks' ),
                'type'        => 'boolean',
                'default'     => false,
            ];
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( ( $post_type === 'contacts' || $post_type === 'tasks' ) && $section === 'disciple_tools_tasks' ){
            /**
...
Disciple_Tools_Tasks_Tile::instance();
