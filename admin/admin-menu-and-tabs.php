...
/**
 * Class Disciple_Tools_Tasks_Menu
 */
class Disciple_Tools_Tasks_Menu {

    public $token = 'disciple_tools_tasks';
    public $page_title = 'Tasks';

    private static $_instance = null;

    /**
     * Disciple_Tools_Tasks_Menu Instance
     *
     * Ensures only one instance of Disciple_Tools_Tasks_Menu is loaded or can be loaded.
     *
     * @since 0.1.0
     * @static
     * @return Disciple_Tools_Tasks_Menu instance
     */
    ...
    public function __construct() {
        ...
        $this->page_title = __( 'Tasks', 'disciple-tools-tasks' );
    } // End __construct()
    ...
    public function content() {
        ...
        <div class="wrap">
            ...
            switch ( $tab ) {
                case 'general':
                    $object = new Disciple_Tools_Tasks_Tab_General();
                    $object->content();
                    break;
                case 'second':
                    $object = new Disciple_Tools_Tasks_Tab_Second();
                    $object->content();
                    break;
                default:
                    break;
...
/**
 * Class Disciple_Tools_Tasks_Tab_General
 */
class Disciple_Tools_Tasks_Tab_General {
    public function content() {
        ?>
    ...
    public function main_column() {
        $token = Disciple_Tools_Tasks_Menu::instance()->token;
...
/**
 * Class Disciple_Tools_Tasks_Tab_Second
 */
class Disciple_Tools_Tasks_Tab_Second {
    public function content() {
        ?>
